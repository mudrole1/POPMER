...
#TODO call this script always as taskset 01 ./yahsp.bash
time[0]=2
time[1]=7
time[2]=15
time[3]=22
...
RESULT=/data/Phd_final/Phd_evaluation/durative/results/driverlog/yahsp_30min_6GB/
i=0
...
do
  ...
  ./../../../../../phd/Phd/temp_evaluation/source_code_ipc2014/tempo-sat-yahsp3-mt/cpt-yahsp/release/cpt_yahsp-mt -y 32,2,2 -N -K 0.01,0.01 -s 2014 -o "$domain" -f "$p" -out "$output" &
  
  pid=$!
  echo "pid"
  echo $pid

  #sudo taskset -p $pid 01
